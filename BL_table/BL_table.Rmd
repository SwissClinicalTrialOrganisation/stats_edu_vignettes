...
In RCTs, groups are defined by treatment allocation. If appropriated, the overall population's characteristics may be presented in a separate column.
...
Question 1: Descriptive statistics are typically given as frequency for categorical or binary variables, mean and (standard deviation)for continuous normal variables and median (25th-75th percentile or minimum-maximum) for non-normal continuous variables.
