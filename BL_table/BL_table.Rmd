...
Groups are defined by treatment allocation for RCTs, disease status for case--control studies or cohorts. If appropriated, the overall population's characteristics may be presented in a separate column.
Characteristics should include information about the study participants (e.g., demographic, clinical, social) and information on exposures and any particular characteristics that may be predictive of the studied outcome (e.g.health status at baseline).
...
Indeed, requirements for the contents and formatting of baseline tables may vary depending on the project, the authors, the target journal, etc. Here we present few (very flexible) options for R and stata.
...
If needed, groups may be compared using statistical tests. **WARNING: as stated above baseline tables are descriptive tables. Pvalues should be avoid**
